...
lib.ssMetadata = [
		{name:"PR_Legion_Pro_7_16IAX10_CM_GDN_300x600_atlas_1", frames: [[0,1806,50,50],[0,0,300,600],[0,602,300,600],[0,1204,300,600],[302,0,300,600],[302,602,300,600],[302,1204,300,600],[604,0,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_Pro_7_16IAX10_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegionPro716IAX10CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
// library properties:
lib.properties = {
	id: '799E3AF3AC11234282FDB1267331B9B8',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_Pro_7_16IAX10_CM_GDN_300x600_atlas_1.png", id:"PR_Legion_Pro_7_16IAX10_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['799E3AF3AC11234282FDB1267331B9B8'] = {
